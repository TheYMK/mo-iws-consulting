...
export default function ServiceDetailContent({
  ...
  const msg = encodeURIComponent(
    `Bonjour, je souhaite des informations sur le service : ${service.title}`,
  );
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
          ...
          >
            <div className="flex items-center gap-5 mb-8">
              ...
              <div>
                <span className="text-fire-400 text-sm font-semibold uppercase tracking-wider">
                  {service.tagline}
                </span>
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                {service.fullDesc.split("\n\n").map((para, i) => (
                  <p
                    key={i}
                    className="text-steel-600 leading-relaxed mb-4 text-base"
                  >
                    {para}
                  </p>
                ))}
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {service.process.map((step) => (
                    <div
                      key={step.step}
                      className="flex gap-5 bg-[#f5f7fa] rounded-2xl p-6 border border-steel-200"
                    >
              ...
              >
                ...
                <div className="space-y-3">
                  {service.benefits.map((benefit) => (
                    <div
                      key={benefit}
                      className="flex items-start gap-3 p-4 rounded-xl bg-fire-500/5 border border-fire-500/15"
                    >
              ...
              >
                ...
                <div className="flex flex-wrap gap-3">
                  {service.industries.map((ind) => (
                    <span
                      key={ind}
                      className="px-4 py-2 bg-navy-900 text-white text-sm font-medium rounded-xl"
                    >
                      {ind}
                    </span>
                  ))}
              ...
              <div className="bg-navy-900 rounded-2xl p-6">
                ...
                <div className="mt-6 pt-6 border-t border-white/10">
                  <p className="text-white/40 text-xs text-center">
                    Réponse sous 24h ouvrées • Devis gratuit
                  </p>
                </div>
              </div>
                  ...
                  {otherServices.map((s) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-navy-900 font-medium text-sm group-hover:text-fire-600 transition-colors">
                          {s.title}
                        </span>
                      </Link>
                    );
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              className="flex items-center gap-2 px-8 py-4 bg-[#25D366] hover:bg-[#1fb855] text-white font-semibold rounded-xl transition-all"
            >
              <MessageCircle className="w-5 h-5 fill-white" /> Contacter via
              WhatsApp
            </a>
          </div>
        </div>
