...
const testimonials = [
  ...
  {
    text: "Grâce à l'audit réalisé par Madi Ousseni, j'ai pu identifier et corriger des non-conformités critiques avant l'audit client. Son rapport d'audit est le plus complet que j'aie jamais reçu.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-steel-600 leading-relaxed mb-6 text-sm italic">
                &ldquo;{t.text}&rdquo;
              </p>
              ...
              <div className="flex gap-1 mt-3">
                {[...Array(5)].map((_, j) => (
                  <span key={j} className="text-fire-400 text-sm">
                    ★
                  </span>
                ))}
              </div>
