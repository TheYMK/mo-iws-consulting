...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#050d1a]">
      ...
      <div
        className="absolute top-1/4 right-1/4 w-2 h-2 rounded-full bg-fire-500 opacity-70 animate-ping"
        style={{ animationDuration: "2.5s" }}
      />
      <div
        className="absolute top-1/3 right-1/3 w-1.5 h-1.5 rounded-full bg-fire-400 opacity-50 animate-ping"
        style={{ animationDuration: "3.5s", animationDelay: "0.5s" }}
      />
      <div
        className="absolute bottom-1/3 right-1/5 w-2.5 h-2.5 rounded-full bg-fire-300 opacity-30 animate-ping"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.08] mb-6">
            Expert en <span className="text-gradient-fire">Soudage</span>{" "}
            <span className="text-white">IWS</span>{" "}
            <span className="text-white/40">–</span>{" "}
            <span className="text-white">
              Coordination, Inspection &amp; Assurance Qualité
            </span>
          </h1>
          ...
          <p className="text-white/60 text-lg sm:text-xl leading-relaxed mb-10 max-w-xl">
            ...
            <span className="text-white font-semibold">
              {SITE.experience} ans d&apos;expérience{" "}
            </span>{" "}
            dans la coordination, l&apos;inspection et l&apos;assurance qualité
            soudage — conformité ISO 14731, ISO 3834 et ISO 9001.
          </p>
            ...
            {[
              {
                ...
                iconEl: <Award className="w-5 h-5 text-fire-400" />,
              },
              {
                val: "IWS",
                label: "Certifié IIW",
                iconEl: <ShieldCheck className="w-5 h-5 text-fire-400" />,
              },
              // {
              //   val: "200+",
              //   label: "Missions réalisées",
              //   iconEl: <Star className="w-5 h-5 text-fire-400" />,
              // },
        ...
        >
          <div className="relative">
            ...
            >
              <p className="text-navy-900 font-bold text-lg leading-none">
                IWS
              </p>
