...
export const SERVICES: Service[] = [
  {
    ...
    shortDesc:
      "Prise en charge complete de la coordination des activites de soudage conformement a la norme ISO 14731.",
    heroImage: IMAGES.chantier,
    fullDesc:
      "La coordination en soudage est une fonction essentielle pour garantir la maitrise technique et la conformite de vos operations. Conformement a la norme ISO 14731, nous assurons l'organisation complete des activites de soudage, de la planification a la validation finale.\n\nNotre intervention couvre la gestion des exigences techniques, l'interface entre production et qualite, ainsi que le suivi rigoureux de la conformite des travaux sur le terrain.",
    benefits: [
    ...
    process: [
      {
        step: "01",
        label: "Analyse",
        desc: "Evaluation du contexte et des exigences de coordination",
      },
      {
        step: "02",
        label: "Organisation",
        desc: "Planification et structuration des operations de soudage",
      },
      {
        step: "03",
        label: "Supervision",
        desc: "Suivi terrain et interface production/qualite",
      },
      {
        step: "04",
        label: "Validation",
        desc: "Verification de la conformite et reporting",
      },
    ],
  },
  {
    ...
    shortDesc:
      "Realisation d'inspections et de controles qualite sur les operations de soudage.",
    heroImage: IMAGES.audit,
    fullDesc:
      "L'inspection et le controle qualite sont indispensables pour garantir la fiabilite et la conformite de vos assemblages soudes. Nous intervenons directement sur vos sites pour verifier la qualite des soudures, controler les parametres de soudage et assurer le suivi des non-conformites.\n\nNotre approche rigoureuse permet d'identifier rapidement les ecarts et de mettre en place les actions correctives necessaires pour valider vos assemblages.",
    benefits: [
    ...
    process: [
      {
        step: "01",
        label: "Preparation",
        desc: "Analyse des plans et des exigences de controle",
      },
      {
        step: "02",
        label: "Inspection",
        desc: "Verification visuelle et controle des parametres",
      },
      {
        step: "03",
        label: "Analyse",
        desc: "Identification des non-conformites et ecarts",
      },
      {
        step: "04",
        label: "Rapport",
  ...
  },
  {
    ...
    fullDesc:
      "L'assurance qualite en soudage est un levier essentiel pour securiser vos processus et repondre aux exigences de vos clients. Nous vous accompagnons dans la mise en place de systemes qualite conformes a la norme ISO 3834, depuis l'audit initial jusqu'a l'amelioration continue.\n\nNotre expertise couvre l'evaluation des pratiques de soudage, la mise en place de procedures qualite adaptees a votre organisation et le suivi des indicateurs de performance.",
    benefits: [
    ...
    process: [
      {
        step: "01",
        label: "Audit",
        desc: "Evaluation initiale des pratiques et de la conformite",
      },
      {
        step: "02",
        label: "Plan",
        desc: "Definition des actions et procedures qualite",
      },
      {
        step: "03",
        label: "Deploiement",
        desc: "Mise en place des procedures et formation des equipes",
      },
      {
        step: "04",
        label: "Suivi",
        desc: "Amelioration continue et maintien de la conformite",
      },
    ],
  },
  {
    ...
    shortDesc:
      "Accompagnement dans la qualification des modes operatoires de soudage.",
    heroImage: IMAGES.dmos,
    fullDesc:
      "La qualification des procedes de soudage est une etape incontournable pour garantir la reproductibilite et la fiabilite de vos assemblages. Nous vous accompagnons dans la redaction et la validation des DMOS, le suivi des essais QMOS et la verification de la conformite aux normes en vigueur.\n\nNotre objectif est de vous fournir des procedes valides, documentes et conformes, prets a etre deployes en production.",
    benefits: [
    ...
    process: [
      {
        step: "01",
        label: "Analyse",
        desc: "Etude des exigences et des normes applicables",
      },
      {
        step: "02",
        label: "Redaction",
        desc: "Elaboration du DMOS avec parametres optimises",
      },
      {
        step: "03",
        label: "Essais",
  ...
  },
  {
    ...
    heroImage: IMAGES.chantier,
    fullDesc:
      "La supervision de travaux est essentielle pour assurer la bonne execution des operations de soudage sur chantier. Notre expert intervient directement aupres de vos equipes pour superviser les soudeurs, veiller au respect des procedures et gerer les aleas techniques.\n\nUn reporting structure permet de suivre l'avancement et de garantir la qualite des travaux en temps reel.",
    benefits: [
    ...
    process: [
      {
        step: "01",
        label: "Preparation",
        desc: "Analyse des plans, procedures et objectifs du chantier",
      },
      {
        step: "02",
        label: "Mobilisation",
        desc: "Deploiement sur site et coordination avec les equipes",
      },
      {
        step: "03",
        label: "Supervision",
        desc: "Suivi quotidien des operations et gestion des aleas",
      },
      {
        step: "04",
        label: "Cloture",
  ...
  },
  {
    ...
    fullDesc:
      "Le suivi de fabrication et des fournisseurs est un maillon essentiel pour garantir la qualite de votre chaine de production. Nous assurons le controle de fabrication, le suivi des sous-traitants, la verification documentaire et la reception des travaux.\n\nNotre intervention permet de detecter les ecarts au plus tot et d'assurer la conformite des livrables a chaque etape du processus.",
    benefits: [
    ...
    process: [
      {
        step: "01",
        label: "Cadrage",
        desc: "Definition du perimetre de suivi et des exigences",
      },
      {
        step: "02",
        label: "Controle",
      ...
      },
      {
        step: "03",
        label: "Verification",
        desc: "Revue documentaire et controle des livrables",
      },
      {
        step: "04",
        label: "Reception",
        desc: "Validation finale et rapport de reception",
      },
    ],
  },
];
